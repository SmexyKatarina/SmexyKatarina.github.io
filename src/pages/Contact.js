            ...
            <Header />
                <div className="contacts">
                    <div className="contact-item border-right border-bottom">
                        ...
                        <h3 className="contact-info" id="info-1">{process.env.REACT_APP_PHONE_NUMBER}</h3>
                    ...
                    <div className="contact-item border-bottom">
                        ...
                        <h3 className="contact-info" id="info-2">{process.env.REACT_APP_HOTMAIL}</h3>
                        <p className="contact-inspect" onClick={() => {
                    ...
                    <div className="contact-item border-right">
                        ...
                        <h3 className="contact-info" id="info-3">{process.env.REACT_APP_GMAIL}</h3>
                        <p className="contact-inspect" onClick={() => {
                    ...
                    <div className="contact-item">
                        ...
                        <h3 className="contact-info" id="info-4">{process.env.REACT_APP_LINKEDIN}</h3>
                        <p className="contact-inspect" onClick={() => {
                            document.getElementById("info-4").style.backgroundColor = "transparent";
                        }}>Click to view LinkedIn</p>
                    </div>
                    <h6 className="contact-cipher">Everything is ciphered for spam reasons</h6>
